...
export async function upsertBirthday(userPhone: string, name: string, month: number, day: number, year?: number) {
	await sql`
...
export async function deleteBirthday(userPhone: string, name: string): Promise<boolean> {
...
export async function getUpcomingBirthdays(userPhone: string, withinDays: number) {
...
export function getDaysUntilNext(from: Date, month: number, day: number): number {
